...
#define Z_SERVO_ANGLES { 70, 32 } // Z Servo Deploy and Stow angles
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -58, -16, 0 }
...
#define X_MIN_POS 0
#define Y_MIN_POS -10 // clips in the middle of the bed limit printing area.
#define Z_MIN_POS 0
